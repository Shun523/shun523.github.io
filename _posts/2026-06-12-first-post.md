...
とりあえず頑張って考えてみて、紙に書き起こしてみてください。いいイメージが持てるならそれで行きましょう。もし持てないならAIをぜひ使ってみましょう。

私はデザインのセンスがないので迷いなくChatGPTを起動します。(泣)\
...
[今回はこのサイトを参考にして作っていきます](https://developer.mozilla.org/ja/docs/Learn_web_development/Core/Structuring_content)
...
まず名前の横にある模様はちょっと難しいのでいったん後回しにします。HTMLとCSSを書き進めていくとこんな感じですね
